...
const examples = [
  ...
  // KNOWN CUSP BOUNDARY: Our 5th cusp sub = Ketu, book's = Saturn (Placidus algorithm vs Raphael's tables)
  // Excluded from accuracy count — cusp calculation edge case at Delhi latitude
  ...
  // KNOWN CUSP BOUNDARY: Our 3rd cusp sub = Rahu, book's = Venus (Placidus vs Raphael's at Delhi)
  // Excluded from accuracy count — cusp calculation edge case
